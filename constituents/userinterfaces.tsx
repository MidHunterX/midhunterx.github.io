...
`;
  ...
  return (
    <section className="bg-center bg-no-repeat bg-[url('/hero.jpg')] bg-gray-700 bg-blend-multiply max-w-screen h-screen py-[100px] lg:px-[80px] sm:px-[50px] flex lg:flex-row sm:flex-col gap-20 items-center">
      ...
      <div className="lg:visible sm:invisible text-white flex flex-col items-center justify-center w-full lg:w-1/3">
